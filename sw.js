...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  var cacheNamePage = "pages";
  var matchCallbackPage = ({ request }) => request.mode === "navigate";
  registerRoute(
    matchCallbackPage,
    new NetworkFirst({
  ...
  var cacheNameImage = "images";
  var matchCallbackImage = ({ request }) => request.destination === "image";
  registerRoute(
    matchCallbackImage,
    new CacheFirst({
